...
# Define the source folder to be duplicated
source_folder = "dashboardk"
...
# Convert the multi-line string into a list of paths, filtering out any empty lines
...
for path in paths:
    ...
    try:
        ...
        print(f"Copied '{source_folder}' to '{path}'.")
    except Exception as e:
        print(f"Failed to copy to '{path}': {e}")
