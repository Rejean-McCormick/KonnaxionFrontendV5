...
// Updated import for the KonnectED Dashboard component
...
const routes = [
  {
    ...
    // Updated route path to reflect the new folder structure
  ...
  },
  {
    ...
    collapse: [
      ...
      },
      {
        ...
        // Updated route to use new naming convention
  ...
  },
  {
    ...
    collapse: [
      ...
      },
      {
        ...
        // Updated route to match new naming convention
